...
namespace JWC
{
	...
	public class MruStripMenu
	{
		...
		public MruStripMenu(MenuItem recentFileMenuItem, ClickedHandler clickedHandler)
		...
		public MruStripMenu(MenuItem recentFileMenuItem, ClickedHandler clickedHandler, int maxEntries)
		...
		public MruStripMenu(MenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName)
		...
		public MruStripMenu(MenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, int maxEntries)
		...
		public MruStripMenu(MenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry)
		...
		/// <param labelName="loadFromRegistry">Loads the MRU settings from the registry immediately.</param>
		/// <param labelName="maxEntries">The maximum number of items on the MRU list.</param>
		public MruStripMenu(MenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry, int maxEntries)
		{
		...
		public int MaxShortenPathLength
		{
			...
			set
			{
				maxShortenPathLength = value < 5 ? 5 : value;
			}
		}
...
//					MenuItems[i].Text = FixupEntryname(startNumber, MenuItems[i].Text.Substring(startNumber == 10 ? 5 : 4));
	...
	public class MruStripMenuInline : MruStripMenu
	{
        ...
        public MruStripMenuInline(MenuItem owningMenu, MenuItem recentFileMenuItem, ClickedHandler clickedHandler)
			: this(owningMenu, recentFileMenuItem, clickedHandler, null, false, 4)
		{
		}

        public MruStripMenuInline(MenuItem owningMenu, MenuItem recentFileMenuItem, ClickedHandler clickedHandler, int maxEntries)
			: this(owningMenu, recentFileMenuItem, clickedHandler, null, false, maxEntries)
		{
		}

        public MruStripMenuInline(MenuItem owningMenu, MenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName)
        ...
        public MruStripMenuInline(MenuItem owningMenu, MenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry)
